...
const CustComponent = () => {
    ...
    const [animationClass, setAnimationClass] = useState("testimonial-active");

    const nextTestimonial = () => {
        setAnimationClass("testimonial-leave");
        setTimeout(() => {
            setCurrentIndex((prevIndex) =>
                prevIndex === testimonials.length - 1 ? 0 : prevIndex + 1
            );
            setAnimationClass("testimonial-enter");
        }, 500);
    };
    ...
    useEffect(() => {
        const timeout = setTimeout(() => {
            setAnimationClass("testimonial-active");
        }, 500);
        ...
        <div className="container-home-cus">
            <div className="testimonials-container">
                <div className="testimonials-header">
                    ...
                    <p>Nuestros sistemas han mejorado la vida y los cultivos de nuestros clientes</p>
                </div>
                ...
                <DividerComponent width="714px" height="1px" color=" background:rgba(255, 255, 255, 1);" />
            </div>
        </div>
    );
};
