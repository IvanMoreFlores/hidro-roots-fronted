        ...
        <div className="container-body-buildi-m">
            <div className="container-title-servi">
                <div className="container-text-title-servi-buildi-m">
                    <p className="text-title-servi-buildi-m">Diseñamos construimos y gestionamos</p>
            ...
            <DividerComponent width="714px" height="1px" color=" background: rgba(229, 229, 229, 1);" />
        </div>
    );
};
