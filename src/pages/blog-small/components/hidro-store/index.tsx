                    ...
                    <div className="product-details">
                        <div className="detail-section">
                            ...
                            <div className="divider-store">
                                <DividerComponent width="417px" height="1px" color=" background: rgba(229, 229, 229, 1);
)" />
                            </div>
                        </div>
                        ...
                        <div className="detail-section">
                            ...
                            >
                                ...
                                <span className={`arrow ${showSpecifications ? 'rotated' : ''}`}>
                                    <Img
                                        src="/img/hidro-store/botton1.png"
                                        width={11.67}
                                        height={5.83}
                        ...
                        <div className="stock-info">
                            ...
                            <div className="stock-text">
                                ...
                                <p className="stock-detail">Disfruta de envíos rápidos y seguros a cualquier ciudad </p>
                                <p className="stock-detail">o región del Perú.</p>

                                <p className="stock-detail">¡Nosotros nos encargamos del resto!</p>
